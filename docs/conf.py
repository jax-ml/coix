...
author = "The coix Authors"

version = ""

if "READTHEDOCS" not in os.environ:
  # if developing locally, use coix.__version__ as version
  from coix import __version__  # noqaE402

  version = __version__

  # Add "Edit on GitHub" button on the upper right corner of local docs.
  html_context = {"github_version": "main", "display_github": True}
...
:github_url: https://github.com/jax-ml/coix/blob/main/{{ docname }}
...
.. raw:: html
    ...
    <div class="admonition note">
      ...
      <span style="white-space: nowrap;">
        <a href="https://colab.research.google.com/github/jax-ml/coix/blob/{{ env.config.html_context.github_version }}/{{ docname }}">
...
# replace "# coix" by "# Getting Started with Coix"
with open("../README.md", "rt") as f:
  ...
  lines[0] = "# Getting Started with Coix\n"
  text = "\n".join(lines)
...
# with open("../notebooks/index.rst", "rt") as f1:
...
# logo
# html_logo = "_static/img/coix_logo_wide.png"
...
man_pages = [(master_doc, "Coix", "Coix Documentation", [author], 1)]
...
intersphinx_mapping = {
    ...
    "numpyro": ("http://num.pyro.ai/en/stable/", None),
}
